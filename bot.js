...
client.user.setGame(`$help |`,"http://twitch.tv/charafmed1 ")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            .setColor("RANDOM")
            .setThumbnail(message.author.avatarURL)
            .setDescription(`**__برودكاست بوت | Bc Bot__ 
            ...
            رابط سيرفر الدعم الفني : https://discord.gg/ZjBCF5Q
            **`);
...
client.login("NjI4OTc3MDIyNDMzMjMwODcw.XZhamw.4SqNNoAOhlXf7sKbvR79UFBGxpU");
